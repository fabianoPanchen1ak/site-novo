                ...
                <div class="col-12">
                    <div class="tf__breadcrumb_text">
                        ...
                        <ul>
							...
							<li><a href="graduacao">Pós-Graduação</a></li>
							<li><a href="cursos_posgraduacao">Cursos</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <section class="tf__courses_page mt_190 xs_mt_95">
        <div class="container">
			...
			<?php 
					...
					$sql = "SELECT ID,IMAGEM, NOME_CURSO, REPLACE(NOME_CURSO_LINK,'-','') AS NOME_CURSO_LINK, 
					SUBNIVEL_ENSINO, IMAGEM, CONTEUDO, 
					COORDENADORES, CAMPUS, NOME_CAMPUS, INSCRICOES_ABERTAS, 
					LINK_INSCRICOES, TEXTO_INSCRICOES, 
					URL_S3_COMPRESSED, CATEGORIA
					FROM curso WHERE ATIVO='S' and SUBNIVEL_ENSINO=3
					ORDER BY NOME_CURSO";
					  ...
					  echo("							
							...
							<div class='tf__single_courses'>
								<div class='tf__single_courses_img'>
									<img src='https://uni-contestado-site.s3.amazonaws.com/site/pos/cursos/$IMAGEM' alt='courses' class='img-fluid w-100'>
									<a class='categories green' href='#'>$CATEGORIA</a>
								</div>
								...
								<div class='tf__single_courses_text'>
									<a class='title' href='cursop/$nome'>$NOME_CURSO</a>
