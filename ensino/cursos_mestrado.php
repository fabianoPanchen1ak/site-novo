    ...
    <section class="tf__courses_page mt_190 xs_mt_95">
        <div class="container">
			...
			<?php 
					...
					FROM curso WHERE ATIVO='S' and SUBNIVEL_ENSINO=4
					ORDER BY NOME_CURSO";
					  ...
					  echo("							
							...
							<div class='tf__single_courses'>
								<div class='tf__single_courses_img'>
									...
									<a class='categories red' href='#'>$CATEGORIA</a>
								</div>
								...
								<div class='tf__single_courses_text'>
									<a class='title' href='cursom/$nome'>$NOME_CURSO</a>
