    ...
    <section class="tf__courses_page mt_190 xs_mt_95">
        <div class="container">
			...
			<?php 
					...
					LINK_INSCRICOES, TEXTO_INSCRICOES, URL_S3_COMPRESSED, CATEGORIA
					FROM curso WHERE ATIVO='S' and SUBNIVEL_ENSINO=10
					ORDER BY NOME_CURSO";
					  ...
					  echo("							
							...
							<div class='tf__single_courses'>
								<div class='tf__single_courses_img'>
									...
									<a class='categories blue' href='#'>$CATEGORIA</a>
								</div>
								...
								<div class='tf__single_courses_text'>
									<a class='title' href='cursod/$nome'>$NOME_CURSO</a>
