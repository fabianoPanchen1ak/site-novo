                ...
                <div class="col-12">
                    <div class="tf__breadcrumb_text">
                        ...
                        <ul>
							...
							<li><a href="bolsas_estudo">Bolsas de estudo</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="col-xl-12 col-lg-12">
                    <div class="tf__courses_details_area">
                        ...
                        <div class="tf__courses_det_text">
                            <h2>Bolsas de Estudo disponíveis pela UnC:</h2>
							<ul>
								<li>Bolsa Atleta</li>
								<li>Bolsa FAP</li>
								<li>Bolsa Mérito</li>
							...
							<br>
							<h2>Programa UNIEDU – Asseguradas pelo Governo de Santa Catarina</h2>
							<ul>
								<li>Bolsa Artigo 170 - Estudo</li>
								<li>Bolsa Artigo 170 - Pesquisa</li>
								<li>Bolsa Artigo 171 - FUMDES Estudo</li>
								<li>Bolsa Artigo 171 - FUMDES Pesquisa</li>
								<li>PROESDE - Desenvolvimento Regional</li>
							</ul>
							<br>
