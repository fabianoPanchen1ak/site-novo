                ...
                <div class="col-12">
                    <div class="tf__breadcrumb_text">
                        ...
                        <ul>
							...
							<li><a href="educacao_basica">Educação Básica</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-4 col-md-6 wow fadeInUp" data-wow-duration="1.5s">
                    <div class="tf__single_category light_blue">
						...
						<a href="https://mafrense.unc.br/">
                        <div class="tf__single_category_text">
                            <h3>Colégio UNC Mafra</h3>
                ...
                <div class="col-xl-4 col-md-6 wow fadeInUp" data-wow-duration="1.5s">
                    <div class="tf__single_category red">
						...
						<a href="https://realizacao.unc.br/">
                        <div class="tf__single_category_text">
                            <h3>Colégio UNC Canoinhas</h3>
                            <p>We can provide you with a handyan in London.</p>
                        </div>
						</a>
                    </div>
