                ...
                <div class="col-12">
                    <div class="tf__breadcrumb_text">
                        ...
                        <ul>
                            ...
                            <li><a href="ensino.php">Extensão</a></li>
							<li><a href="cursos_qualificacao.php">Cursos de qualificação</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <section class="tf__courses_page mt_190 xs_mt_95">
        <div class="container">
			...
			<?php 
					...
					FROM curso WHERE ATIVO='S' and SUBNIVEL_ENSINO=12
					ORDER BY NOME_CURSO";
					  ...
					  echo("							
							...
							<div class='tf__single_courses'>
								<div class='tf__single_courses_img'>
									...
									<a class='categories orange' href='#'>Qualificação</a>
								</div>
								...
								<div class='tf__single_courses_text'>
									<a class='title' href='cursoq/curso.php?id=$nome'>$NOME_CURSO</a>
