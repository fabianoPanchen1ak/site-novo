                ...
                <div class="col-12">
                    <div class="tf__breadcrumb_text">
                        ...
                        <ul>
							...
							<li><a href="cursos_posgraduacao.php">Cursos de Pós-Graduação</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <section class="tf__courses_page mt_190 xs_mt_95">
        <div class="container">
			...
			<?php 
					...
					FROM curso WHERE ATIVO='S' and SUBNIVEL_ENSINO=11
					ORDER BY NOME_CURSO";
					  ...
					  echo("							
							...
							<div class='tf__single_courses'>
								<div class='tf__single_courses_img'>
									...
									<a class='categories green' href='#'>Pós-graduacao/EAD</a>
								</div>
								...
								<div class='tf__single_courses_text'>
									<a class='title' href='cursog/curso.php?id=$nome'>$NOME_CURSO</a>
